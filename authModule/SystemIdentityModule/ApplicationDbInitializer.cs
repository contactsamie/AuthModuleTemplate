...
//using System.Web;
//using SystemIdentityModule.Models;
...
namespace SystemIdentityModule
{
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db) {
            ...
            var name = CONFIGURATIONS.Application.Configuration.AdminAccount.UserName;
             var password = CONFIGURATIONS.Application.Configuration.AdminAccount.Password;
             const string roleName = "Admin";
            var email = CONFIGURATIONS.Application.Configuration.AdminAccount.EMail;
